...
import type { AgencySelection as _AgencySelection, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createCustomAgency(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createCustomAgency(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllAgencies(): Promise<Array<Agency>> {
        if (this.processError) {
            try {
    ...
    async getCallerAgencySelection(): Promise<AgencySelection | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerAgencySelection();
    ...
    async selectPredefinedAgency(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.selectPredefinedAgency(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AgencySelection]): AgencySelection | null {
...
function from_candid_record_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        lastPlayed: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.lastPlayed)),
        name: value.name
    };
}
